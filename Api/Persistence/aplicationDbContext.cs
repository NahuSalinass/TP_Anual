...
namespace Api.Persistence;
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Producto>().HasData(
            new Producto("Zapatillas", 99, "Zapatos", 10, "unaimagen.jpg")
        );

        var producto1 = new Producto("Zapatillas2", 99, "Zapatos1", 10, "unaimagen.jpg");
        
        modelBuilder.Entity<Publication>().HasData(
            new Publication("VENDO ZAPAS", "Zapatillas Air Jordan", 99, producto1)
        );
    }
}
